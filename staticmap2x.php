...
Class staticMapLite
{
    ...
    protected $maxWidth = 10240;
    protected $maxHeight = 10240;

    // protected $tileSize = 256;
    protected $tileSize = 512;
    protected $tileSrcUrl = array(
        'staman' => 'http://a.tile.stamen.com/toner/{Z}/{X}/{Y}@2x.png',
        'tonerlite' => 'http://a.tile.stamen.com/toner-lite/{Z}/{X}/{Y}@2x.png',
    );

    protected $tileDefaultSrc = 'staman';
    ...
    public function parseLiteParams()
    {
        ...
        if ($_GET['size']) {
            ...
            $this->width = intval($this->width*2);
            // if ($this->width > $this->maxWidth) $this->width = $this->maxWidth;
            $this->height = intval($this->height*2);
